...
import datetime
import math
from .IMR import IMR, Motion, TemporalSegment
from .MiniLesson import ActivityPause, MiniLesson, MiniLessonActivity, TimedInstruction, MotionLessonHeader
from .Workflow import Workflow, WorkflowStage, WorkflowStepUploadData, WorkflowStep, WorkflowStepActivityReference
...
def create_lesson(imr: IMR) -> Workflow:
